...
class MyPageBookmarkEditDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlMypageBookmarkEditBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlMypageBookmarkEditBinding.inflate(layoutInflater)
