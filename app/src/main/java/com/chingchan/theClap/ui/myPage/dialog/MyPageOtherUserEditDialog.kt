...
import com.chingchan.theClap.databinding.DlMypageOtherUserEditBinding
import com.chingchan.theClap.databinding.DlMypageRecCompEditBinding


class MyPageOtherUserEditDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlMypageOtherUserEditBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlMypageOtherUserEditBinding.inflate(layoutInflater)
