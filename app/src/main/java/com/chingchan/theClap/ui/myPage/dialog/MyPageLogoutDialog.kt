...
import com.chingchan.theClap.databinding.DlMypageLogoutBinding
...
class MyPageLogoutDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlMypageLogoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlMypageLogoutBinding.inflate(layoutInflater)
