...
class CompCmtEditDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlCompCmtEditBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlCompCmtEditBinding.inflate(layoutInflater)
