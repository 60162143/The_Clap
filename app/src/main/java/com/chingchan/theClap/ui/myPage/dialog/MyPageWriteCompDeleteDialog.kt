...
import com.chingchan.theClap.databinding.DlMypageRecCompDeleteBinding
...
class MyPageWriteCompDeleteDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlMypageRecCompDeleteBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlMypageRecCompDeleteBinding.inflate(layoutInflater)
