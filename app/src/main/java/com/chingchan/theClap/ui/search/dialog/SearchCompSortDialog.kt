package com.chingchan.theClap.ui.search.dialog
...
import com.chingchan.theClap.databinding.DlMypageBookmarkEditBinding
import com.chingchan.theClap.databinding.DlMypageRecCompEditBinding
import com.chingchan.theClap.databinding.DlSearchCompSortBinding


class SearchCompSortDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlSearchCompSortBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlSearchCompSortBinding.inflate(layoutInflater)
