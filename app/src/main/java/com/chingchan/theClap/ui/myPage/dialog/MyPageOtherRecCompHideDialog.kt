...
class MyPageOtherRecCompHideDialog(context: Context) : Dialog(context) {
    ...
    private lateinit var binding: DlMypageRecCompHideBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DlMypageRecCompHideBinding.inflate(layoutInflater)
